<?php
// lib/php/themes/bootstrap/solidus/clients.php 20190225 - 20190319
// Copyright (C) 2015-2019 Mark Constable <markc@renta.net> (AGPL-3.0)

class Themes_Bootstrap_Solidus_Clients extends Themes_Bootstrap_Theme
{
        ...
        return '
          ...
          <div class="row">
            <div class="table-responsive">
              <table id="solidus_clients" class="table table-sm" style="min-width:1100px;table-layout:fixed">
                <thead class="nowrap">
                  <tr>
...
$(document).ready(function() {
  $("#solidus_clients").DataTable({
    "processing": true,
    "serverSide": true,
    "ajax": "?x=json&o=solidus_clients&m=list"
  });
});
          </script>';
    }
